...
class CurrencyToRubCommandUnitTest {
    ...
    void userNotFound() {
        Update update = mockUpdate(1L, "user", "/currencyToRub USD");
    ...
    void userBannedOrDeletedOrUnverified() {
        Update update = mockUpdate(2L, "user", "/currencyToRub USD");
    ...
    void noCurrencyCode_noCurrencies() {
        Update update = mockUpdate(3L, "user", "/currencyToRub");
    ...
    void noCurrencyCode_withCurrencies() {
        Update update = mockUpdate(4L, "user", "/currencyToRub");
    ...
    void currencyNotFound() {
        Update update = mockUpdate(5L, "user", "/currencyToRub XXX");
    ...
    void success() {
        Update update = mockUpdate(6L, "user", "/currencyToRub USD");
    ...
    void handle_exception() {
        Update update = mockUpdate(7L, "user", "/currencyToRub USD");
