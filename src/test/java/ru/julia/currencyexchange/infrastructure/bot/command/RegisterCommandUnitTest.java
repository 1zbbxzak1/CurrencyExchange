...
class RegisterCommandUnitTest {
    ...
    void startRegistration() {
        Update update = mockUpdate(1L, "user", "/register");
    ...
    void invalidEmail() {
        Update update = mockUpdate(2L, "user", "bademail");
    ...
    void validEmail() {
        Update update = mockUpdate(3L, "user", "test@mail.com");
    ...
    void shortPassword() {
        Update update = mockUpdate(4L, "user", "123");
    ...
    void userAlreadyExists() {
        Update update = mockUpdate(5L, "user", "123456");
    ...
    void successfulPassword() {
        Update update = mockUpdate(6L, "user", "123456");
        ...
        ru.julia.currencyexchange.application.bot.settings.RegistrationData data = new ru.julia.currencyexchange.application.bot.settings.RegistrationData();
    ...
    void errorOnCreateUser() {
        Update update = mockUpdate(7L, "user", "123456");
    ...
    void successfulVerification() {
        Update update = mockUpdate(8L, "user", "code");
    ...
    void invalidVerificationCode() {
        Update update = mockUpdate(9L, "user", "badcode");
    ...
    void errorOnVerification() {
        Update update = mockUpdate(10L, "user", "badcode");
