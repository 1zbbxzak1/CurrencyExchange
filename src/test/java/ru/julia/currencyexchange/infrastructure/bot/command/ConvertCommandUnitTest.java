...
class ConvertCommandUnitTest {
    ...
    class Handle {
        ...
        void waitingAmount_invalidAmount() {
            Update update = mockUpdate(3L, "user", "123");
        ...
        void waitingAmount_success() {
            Update update = mockUpdate(4L, "user", "100");
        ...
        void waitingAmount_conversionError() {
            Update update = mockUpdate(5L, "user", "bad");
        ...
        void showFromCurrencySelection_noCurrencies() {
            Update update = mockUpdate(6L, "user", "/convert");
        ...
        void handleSingleCurrency_notFound() {
            Update update = mockUpdate(8L, "user", "/convert USD");
        ...
        void handleCurrencySelection_notFound() {
            Update update = mockUpdate(9L, "user", "/convert USD EUR");
        ...
        void handleFullConvert_success() {
            Update update = mockUpdate(10L, "user", "/convert USD EUR 100");
        ...
        void handleFullConvert_invalidAmount() {
            Update update = mockUpdate(11L, "user", "/convert USD EUR 100");
        ...
        void handleFullConvert_error() {
            Update update = mockUpdate(12L, "user", "/convert USD EUR 100");
    ...
    class Meta {
        ...
        void matches_byState() {
            Update update = mockUpdate(2L, "user", "any");
