...
@Aspect
@Component
public class DtoMapperLoggingAspect extends AbstractLoggingAspect {
    private static final Logger logger = LoggerFactory.getLogger(DtoMapperLoggingAspect.class);
    private static final long SLOW_THRESHOLD_MS = 500;

    private static final String SLOW_MSG = "[traceId={}] [user={}] Slow DTO mapping: {} took {} ms";
    private static final String NULL_MSG = "[traceId={}] [user={}] DTO mapping method {} returned null";
    private static final String ERROR_MSG = "[traceId={}] [user={}] Exception in DTO mapping {} after {} ms: {}";
    ...
    @Around("within(ru.julia.currencyexchange.application.util.DtoMapper)")
    public Object logDtoMapperMethod(ProceedingJoinPoint joinPoint) throws Throwable {
