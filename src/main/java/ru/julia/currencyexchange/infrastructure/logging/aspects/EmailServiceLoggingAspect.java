...
@Aspect
@Component
public class EmailServiceLoggingAspect extends AbstractLoggingAspect {
    private static final Logger logger = LoggerFactory.getLogger(EmailServiceLoggingAspect.class);
    private static final long SLOW_THRESHOLD_MS = 1200;

    private static final String SLOW_MSG = "[traceId={}] [user={}] Slow email service execution: {} took {} ms";
    private static final String NULL_MSG = "[traceId={}] [user={}] Email service method {} returned null";
    private static final String ERROR_MSG = "[traceId={}] [user={}] Exception in email service {} after {} ms: {}";
    ...
    @Around("within(ru.julia.currencyexchange.application.service.emails..*)")
    public Object logEmailServiceMethod(ProceedingJoinPoint joinPoint) throws Throwable {
