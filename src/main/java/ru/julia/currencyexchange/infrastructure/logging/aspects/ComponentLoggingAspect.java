...
public class ComponentLoggingAspect extends AbstractLoggingAspect {
    private static final Logger logger = LoggerFactory.getLogger(ComponentLoggingAspect.class);
    private static final long SLOW_THRESHOLD_MS = 1500;

    private static final String SLOW_MSG = "[traceId={}] [user={}] Slow component execution: {} took {} ms";
    private static final String NULL_MSG = "[traceId={}] [user={}] Component method {} returned null";
    private static final String ERROR_MSG = "[traceId={}] [user={}] Exception in component {} after {} ms: {}";
