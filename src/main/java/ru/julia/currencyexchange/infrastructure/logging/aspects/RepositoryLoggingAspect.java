...
public class RepositoryLoggingAspect extends AbstractLoggingAspect {
    ...
    private static final String SLOW_MSG = "[traceId={}] [user={}] Slow repository execution: {} took {} ms";
    private static final String NULL_MSG = "[traceId={}] [user={}] Repository method {} returned null";
    private static final String ERROR_MSG = "[traceId={}] [user={}] Exception in repository {} after {} ms: {}";
    ...
    @Around("within(ru.julia.currencyexchange.infrastructure.repository..*)")
