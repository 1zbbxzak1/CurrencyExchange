...
-- changeset accou:1750840311222-1
...
-- changeset accou:1750840311222-2
...
-- changeset accou:1750840311222-3
CREATE TABLE report
(
    id         VARCHAR(255)                NOT NULL,
...
-- changeset accou:1750840311222-4
CREATE TABLE roles
(
    id        VARCHAR(255) NOT NULL,
...
-- changeset accou:1750840311222-5
...
-- changeset accou:1750840311222-6
...
-- changeset accou:1750840311222-7
CREATE TABLE users
(
    id                VARCHAR(255)                NOT NULL,
    chat_id           BIGINT,
...
-- changeset accou:1750840311222-8
ALTER TABLE currencies
    ADD CONSTRAINT uc_currencies_code UNIQUE (code);

-- changeset accou:1750840311222-9
ALTER TABLE roles
    ADD CONSTRAINT uc_roles_role_name UNIQUE (role_name);

-- changeset accou:1750840311222-10
ALTER TABLE settings
    ADD CONSTRAINT uc_settings_user UNIQUE (user_id);

-- changeset accou:1750840311222-11
ALTER TABLE users
    ADD CONSTRAINT uc_users_email UNIQUE (email);

-- changeset accou:1750840311222-12
ALTER TABLE users
    ADD CONSTRAINT uc_users_username UNIQUE (username);

-- changeset accou:1750840311222-13
